...
/**
 * Validate input for export generation
 * @param {Array} participants
 * @param {Object} event
 */
function validateInput(participants, event) {
 ...
 * @returns {Object} Object containing workbook and worksheet
 */
...
/**
 * Add participant data rows with conditional formatting
 * @param {Object} worksheet
 * @param {Array} participants
 * @param {Object} event
 * @param {boolean} isStreaming
